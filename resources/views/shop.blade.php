                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <ul class="list list-inline mb-0 brand-list">
                                    @foreach ($brands as $brand)
                                        <li class="list-item">
                                            <span class="menu-link py-1"> <input type="checkbox" name="brands" value="{{$brand->id}}" class="chk-brand"  @if(in_array($brand->id,explode(',',$f_brands))) checked="checked" @endif  /> {{$brand->name}}</span> <span class="text-right float-end">{{$brand->products()->count()}}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <div class="pc__img-wrapper">
                                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <a href="{{route('shop.product.details',["product_slug"=>$product->slug])}}">
                                                <img loading="lazy" src="{{asset('uploads/products')}}/{{$product->images}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                            </a>
                                        </div>
                                    </div>
...
{{--                    </ul>--}}
{{--                    <a href="#" class="btn-link d-inline-flex align-items-center">--}}
{{--                        <span class="fw-medium me-1cart.add">NEXT</span>--}}
...
@push('scripts')
    <script>
        // Trigger the form submission when the page size changes
        $("#pagesize").on("change",function(){
            $("#size").val($(this).val());
            $("#frmfilter").submit();
        });

        // Trigger the form submission when the order changes
        ...
        $("input[name='brands']").on("change",
            function()
            {
                var brands ="";
                $("input[name='brands']:checked").each(
                function()
                {
                    if(brands=="")
                    {
