                ...
                <div class="wg-box">
                    <fieldset>
                        ...
                        <div class="upload-image mb-16">
                            @if($product->image)
                                <div id="imgpreview_main" class="image-preview-container">
                    ...
                    <fieldset>
                        <div class="body-title">Upload images(other) <span class="tf-color-1">*</span></div>
                        <div class="upload-image flex-grow">
                            @if($product->images)
                                <div id="imgpreview_other" class="image-preview-container">
                                    <img src="{{asset('uploads/products')}}/{{$product->images}}" class="effect8" alt="">
                                </div>
                            @endif
                            <div id="upload-file" class="item up-load">
                                <label class="uploadfile" for="myFiles">
                                    ...
                                    <span class="body-text">Drop your images here or select <span class="tf-color">click to browse</span></span>
                                    <input type="file" id="myFiles" name="images" accept="image/*">
                                </label>
                            </div>
                        </div>
                    </fieldset>
        ...
        $(function() {
            function previewImages(input, previewContainerId) {
                ...
                if (file) {
                    ...
                    previewContainer.append($('<div class="item"></div>').append(img));
            ...
            $("#myFile").on("change", function(e) {
                previewImages(this, "#imgpreview_main");
            });

            // For the other images
            $("#myFiles").on("change", function(e) {
                previewImages(this, "#imgpreview_other");
            });
