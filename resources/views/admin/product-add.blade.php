                ...
                <div class="wg-box">
                    <fieldset>
                        ...
                        <div class="upload-image mb-16">
                            <div id="imgpreview_main" class="image-preview-container"></div>
                    ...
                    <fieldset>
                        <div class="body-title">Upload (other) images <span class="tf-color-1">*</span></div>
                        <div class="upload-image mb-16">
                            <div id="imgpreview_other" class="image-preview-container"></div>
                            <div id="upload-file" class="item up-load">
